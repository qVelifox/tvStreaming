...
if (template) {
  template.innerHTML = String.raw/*html*/`
    ...
    <template partial="PlayButton">
      ...
      >
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="play" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="pause" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <template partial="SeekBackwardButton">
      ...
      >
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="icon" fill="currentColor">
          <path d="M11.99 5V3.48a.5.5 0 0 0-.84-.36l-3.48 3.3a.5.5 0 0 0 .01.73l3.48 3.17a.5.5 0 0 0 .83-.36V9.01a5 5 0 1 1-2.4 9.32.5.5 0 0 0-.5-.86A6 6 0 1 0 12 6v-.01h-.01Z" />
          <text class="value" x="12" y="17" text-anchor="middle" style="font-size: 7px; font-weight: 700; font-family: 'Outfit', sans-serif;">
    ...
    <template partial="SeekForwardButton">
      ...
      >
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="icon" fill="currentColor">
          <path d="M12.01 5V3.48a.5.5 0 0 1 .84-.36l3.48 3.3a.5.5 0 0 1-.01.73l-3.48 3.17a.5.5 0 0 1-.83-.36V9.01a5 5 0 1 0 2.4 9.32.5.5 0 0 1 .5-.86A6 6 0 1 1 12 6v-.01Z" />
          <text class="value" x="12" y="17" text-anchor="middle" style="font-size: 7px; font-weight: 700; font-family: 'Outfit', sans-serif;">
    ...
    <template partial="MuteButton">
      <media-mute-button part="mute button" disabled="{{disabled}}" aria-disabled="{{disabled}}">
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="high" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />
          <path d="M16 9a5 5 0 0 1 0 6" />
          <path d="M19.364 18.364a9 9 0 0 0 0-12.728" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="medium" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />
          <path d="M16 9a5 5 0 0 1 0 6" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="low" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="off" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />
    ...
    <template partial="PipButton">
      <media-pip-button part="pip button" disabled="{{disabled}}" aria-disabled="{{disabled}}">
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="enter" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
          <rect x="11" y="9" width="9" height="6" rx="1" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" slot="exit" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
          <rect x="11" y="9" width="9" height="6" rx="1" fill="currentColor" stroke="none" />
        </svg>
      </media-pip-button>
    </template>
